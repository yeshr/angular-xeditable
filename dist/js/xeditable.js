      ...
      function($parse, $document, $rootScope, editablePromiseCollection, editableUtils, $q) {
        ...
        var base = {
          ...
          $show: function() {
            ...
            if (shown.length > 0) {
              for (var i=0; i<shown.length; i++) {
                toWait.push(shown[i].$promise);
              }

              $q.all(toWait).then(angular.bind(this, showForm));
            }
            else {
              angular.bind(this, showForm)();
            }
          ...
          $submit: function() {
            ...
            pc.then({
              ...
              onString: angular.bind(this, function () {
                this.$activate();
        ...
        return function() {
          return angular.extend({
            ...
            $waiting: false,
            /**
             * A promise that will either be rejected when a form has error and resolved
             * when data is saved to model.
             *
             * @var {object} $promise
             * @memberOf editable-form
             */
